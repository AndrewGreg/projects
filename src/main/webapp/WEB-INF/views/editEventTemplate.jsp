...
<%
	...
	//String id = Long.toString(editEvent.getId());
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="wrapper">
		...
		<div class="content container content-container">
			<div class="page-wrapper ben-container">
				...
				<h1 class="heading-title pull-left">Edit an Event</h1>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						...
						<form action="/Alumni-Tracker/editAnEvent/<%=editEvent.getId()%>" method="POST" name="editAnEvent">
								...
								<div class="form-group col-sm-12">
									...
									<div class="controls">
										<input type="text" id="name" name="name" placeholder="Event"
											class="form-control" value="<%=editEvent.getName()%>" autofocus>
								...
								<div class="form-group col-sm-12">
									...
									<div class="controls">
										<textarea rows="5" id="description" name="description"
											...
											class="form-control" value="<%=editEvent.getDescription()%>"></textarea>
