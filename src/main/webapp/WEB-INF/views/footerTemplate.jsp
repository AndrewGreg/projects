			...
			<div class="row">
				<div class="footer-col col-md-3 col-sm-4 about">
					<div class="footer-col-inner">
						<h3>About</h3>
						<ul>
							<li><a href="/Alumni-Tracker/content/img/BuMap.jpg"><i class="fa fa-caret-right"></i>Campus Map</a></li>
							<li><a href="/Alumni-Tracker/eventsTemplate"><i class="fa fa-caret-right"></i>Events</a></li>
							<li><a href="/Alumni-Tracker/jobsTemplate"><i class="fa fa-caret-right"></i>Jobs</a></li>
							<li><a href="/Alumni-Tracker/testimonialsList"><i class="fa fa-caret-right"></i>Testimonials</a></li>
						</ul>
					</div>
					<!--//footer-col-inner-->
				</div>
