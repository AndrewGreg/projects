		...
		<div class="content container">
			...
			<section class="promo box box-dark">
				...
				<div class="col-md-9">
					...
					%>
					<div class="col-md-3">
						<a class="btn btn-cta" href="/Alumni-Tracker/register"><i
							class="fa fa-pencil"></i>Register Now</a>
					</div>
					<%
						}
					%>
						...
						<div class="carousel-inner">
							...
							<div class="item">
								...
								<div class="col-md-4 ">
									...
									<a class="read-more" href="/Alumni-Tracker/jobs/<%=jobId%>">Read
			...
			<div class="row cols-wrapper">
				<div class="col-md-3">
					<section class="events">
						...
						<div class="section-content">
							...
							<a class="read-more" href="/Alumni-Tracker/eventsTemplate">All
				...
				<div class="col-md-6">
					<section class="course-finder">
						...
						<div class="section-content">
							...
							<!--//course-finder-form-->
							<a class="read-more" href="/Alumni-Tracker/jobs">View all job
								postings<i class="fa fa-chevron-right"></i>
							</a>
						</div>
						<!--//section-content-->
					</section>
				...
				<div class="col-md-3">
					<section class="links">
						...
						<div class="section-content">
							<p>
								<a href="/Alumni-Tracker/faculty"><i
									class="fa fa-caret-right"></i>Faculty Directory</a>
							</p>
							<p>
								<a href="/Alumni-Tracker/alumni"><i
									class="fa fa-caret-right"></i>Alumni Directory</a>
							</p>
							<p>
								<a href="/Alumni-Tracker/eventsTemplate"><i
									class="fa fa-caret-right"></i>Events</a>
							</p>
							<p>
								<a href="/Alumni-Tracker/jobs"><i class="fa fa-caret-right"></i>Job
									Postings</a>
							</p>
						</div>
						<!--//section-content-->
