	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header" style="padding: 35px 50px;">
				...
				<h4 class="modalh4">
					<span class="glyphicon glyphicon-pencil"></span> Tell us what you think!
				</h4>
			</div>
			<div class="modal-body" style="padding: 40px 50px;">
				...
				%>
				<small id="testimonialErrorMsg">Invalid input. Please try
					again.</small>
				...
				<form role="form" action="/Alumni-Tracker/testimonial" method="POST"
					...
					<div class="form-group">
						<textarea class="form-control" rows="8" id="testimonial" name="testimonial"
							placeholder="I think..." class="form-control" autofocus><%=testimonial%></textarea>
					</div>
